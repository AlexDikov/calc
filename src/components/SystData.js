        ...
        <div>
          <div className="systData">
            ...
            <Row>
              ...
              <Col xs={3}>
                <Form.Control
                  id="brick-area"
                  className="w-25"
                  value={context.brickArea}
                  onChange={context.handleBrickArea}
                ></Form.Control>
              </Col>
              <Col>
            ...
            <Row className="mt-3">
              ...
              <Col xs={3}>
                <Form.Control
                  id="concrete-area"
                  className="w-25"
                  value={context.concreteArea}
                  onChange={context.handleConcreteArea}
                ></Form.Control>
              </Col>
              <Col>
                <Form id="window-depth" onChange={context.handleWindowDepth}>
                  {['radio'].map((type) => (
            ...
            <Row className="mt-3">
              ...
              <Col xs={3}>
                <Form.Control
                  id="window-length"
                  className="w-25"
                  value={context.windowLength}
                  onChange={context.handleWindowLength}
                ></Form.Control>
              </Col>
              <Col>
            ...
            <Row className="mt-3">
              ...
              <Col xs={3}>
                <Form.Control
                  id="grib-pcs"
                  className="w-25"
                  value={context.gribPcs}
                  onChange={context.handleGribPcs}
                ></Form.Control>
              </Col>
              <Col>
                <Form id="window-height" onChange={context.windowHeight}>
                  {['radio'].map((type) => (
                    <div key={`inline-${type}`} className="mb-3">
                      <Form.Check
                        label="0 мм"
            ...
            <Row className="mb-3">
              ...
              <Col xs={7}>
                <Form.Select id="grib" className="w-25" value={context.grib} onChange={context.handleGrib}>
